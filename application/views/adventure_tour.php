...
<section class="featured_services py-5">
	<div class="container py-sm-3">
		<h2 class="heading text-center mb-sm-5 mb-4">Adventure Tour</h2>
		...
		<?php foreach($tbl_adventure_tour as $t){ ?>
			<div class="col-lg-4 col-sm-6 mb-5 w3_agile_services_grid">
				<div class="agile_services_grid">
					...
					<a href="<?php echo site_url('adventure_tour/detail/'.$t['id_adventure_tour']);?>">	
						<div>
